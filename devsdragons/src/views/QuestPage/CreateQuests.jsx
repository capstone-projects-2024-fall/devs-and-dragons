...
const CreateQuestsPage = () => {
  ...
  const handleCreateQuest = async (e) => {
    ...
    try {
      const response = await axios.post('http://127.0.0.1:5000/quest-parameters', { questTitle, codingTopic, problemCount, difficultyLevel, enemy, background, description, programmingLanguage, gameType, roomCode: gameType === 'two-player' ? roomCode: null,});
